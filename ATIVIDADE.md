...
O teto de contribuição (faixa máxima) é R$ 8.157,41, o que gera um desconto máximo de **R$ 951,62**.

---

### IRRF (Imposto de Renda Retido na Fonte)

O desconto do IRRF é calculado de acordo com a faixa salarial do funcionário:
...
O desconto acontecerá sobre o salário bruto do funcionário

---

### Vale Refeição
Solicite o valor que a empresa paga de vale refeição.
Desconto de 20% do valor do benefício fornecido pela empresa no salário bruto do funcionário.
...
|---------|--------------|-------------|------------------|----------------|------------------|
| 1       | R$ 1.518,00  | 0           | Sim              | R$ 500,00      | R$   ?       |
| 2       | R$ 10.000,00 | 2           | Não              | R$ 800,00      | R$   ?        |
